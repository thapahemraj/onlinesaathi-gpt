...
/**
 * Online Saathi Cache Flush Utility
 *
 * This script flushes the cache store used by Online Saathi, whether it's
...
DESCRIPTION:
  Flushes the cache store used by Online Saathi. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the Online Saathi backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 Online Saathi Cache Flush Utility');
  console.log('================================');
