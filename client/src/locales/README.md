# Online Saathi Localization Guide

This guide explains how to add new languages to Online Saathi's localization system.

## Adding a New Language

To add a new language to Online Saathi, follow these steps:

### 1. Add the Language to Locize Project

- Navigate to the [Online Saathi locize project](https://www.locize.app/cat/62uyy7c9), 
...
1. The empty translation file will be populated through Online Saathi's automated translation platform
